...
1. For **Rule collection action**, use **Allow**. For **Rule collection group**, use **DefaultApplicationRuleCollectionGroup**.
...
1. For **Rule collection action**, use **Allow**. For **Rule collection group**, use  **DefaultNetworkRuleCollectionGroup**.
...
- [Create a Managed Lustre file system in the Azure portal](/azure/azure-managed-lustre/create-file-system-portal)
