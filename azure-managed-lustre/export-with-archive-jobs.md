...
To learn more about scenarios where you might need to retry an export job, see [Running export jobs in active file systems](blob-integration.md#running-export-jobs-in-active-file-systems).
