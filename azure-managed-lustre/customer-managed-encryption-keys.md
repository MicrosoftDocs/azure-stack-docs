...
![Example of a keyvault networking configuration that is restricted to selected networks, but allows trusted Microsoft services.](media/customer-managed-encryption-keys/keyvault-network-config.png)
> [!NOTE]
