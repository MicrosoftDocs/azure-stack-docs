...
| v0.3.0          | mcr.microsoft.com/oss/kubernetes-csi/azurelustre-csi:v0.3.0   | 1.21+                 | 2.15.5                | ✅                    |
...
| v0.1.13         | mcr.microsoft.com/oss/kubernetes-csi/azurelustre-csi:v0.1.13  | 1.21+                 | 2.15.4                | ❌                    |
| v0.1.12         | mcr.microsoft.com/oss/kubernetes-csi/azurelustre-csi:v0.1.12  | 1.21+                 | 2.15.3                | ❌                    |
| v0.1.11         | mcr.microsoft.com/oss/kubernetes-csi/azurelustre-csi:v0.1.11  | 1.21+                 | 2.15.1                | ❌                    |
| v0.1.10         | mcr.microsoft.com/oss/kubernetes-csi/azurelustre-csi:v0.1.10  | 1.21+                 | 2.15.2                | ❌                    |
...
- **Important:** Plan to migrate to Azure CNI Overlay before the retirement date
...
> [!IMPORTANT]
> **IMPORTANT NOTE**: Before using this CSI driver to dynamically create Azure Managed Lustre clusters, the kubelet identity must have the correct permissions granted to it.
...
Note that this only deletes the Kubernetes resources. The Azure Managed Lustre file system itself will continue to exist and can be reused.
