...
If you've already installed a resource provider, you've likely completed the common prerequisites, and can skip this section. Otherwise, complete the following prerequisites first: 
