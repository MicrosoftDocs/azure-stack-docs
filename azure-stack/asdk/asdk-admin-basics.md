...
Click **Help** (question mark) in the upper-right corner of the admin portal and then click **Help + support** to open Help + Support **Overview**, which has a link to the forum. 
