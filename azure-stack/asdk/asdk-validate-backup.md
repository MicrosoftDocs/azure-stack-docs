...
Next, copy your Azure Stack backup files to the newly created share. Make sure to copy everything from the parent folder to the root of the share `\\<ComputerName>\AzSBackups\`.
