...
You can use the [ARM template for 3-node storage switchless, dual TOR and single link](/azure/quickstarts/microsoft.azurestackhci/create-cluster-3Nodes-Switchless-SingleLink).
