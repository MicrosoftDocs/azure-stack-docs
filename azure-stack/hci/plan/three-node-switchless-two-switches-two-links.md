...
You can use the [ARM template for 3-node storage switchless, dual TOR and dual link](/azure/quickstarts/microsoft.azurestackhci/create-cluster-3Nodes-Switchless-DualLink).
