---
title: Known issues in Azure Stack HCI 2306.1 Supplemental Package (preview)
description: Read about the known issues in Azure Stack HCI 2306.1 Supplemental Package (preview).
author: alkohli
ms.topic: conceptual
ms.date: 07/11/2023
ms.author: alkohli
...
# View known issues in Azure Stack HCI, 2306.1 Supplemental Package release (preview)
...
This article applies to Azure Stack HCI, Supplemental Package, for 2306.1 release. This release maps to software version number **10.2306.0.47**. This release supports following:
