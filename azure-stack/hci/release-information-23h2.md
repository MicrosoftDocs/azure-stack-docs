...
|--|--|--|--|--|
| 10.2405.1.XX | XXXXX.XXX  <br><br> [June OS security update](./security-update/hci-security-update-jun-2024.md) <br><br> Availability date: 2024-06-XX | Update | [Features and improvements](./whats-new.md#features-and-improvements-in-2405-1) | [Known issues](./known-issues-2405-1.md) |
