...
|--|--|--|--|--|
| 10.2408.1.9  | 25398.1128 <br><br> [September OS Security update](./security-update/hci-security-update-sep-2024.md) <br><br> Availability date: 2024-09-24 | Baseline | [Features and improvements](./whats-new.md#features-and-improvements-in-24081) | [Known issues](./known-issues-2408-1.md) |
