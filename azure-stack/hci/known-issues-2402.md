...
| Deployment <!--26852606--> |In this release, there is a remote task failure on a multi-node deployment that results in the following exception:<br>```ECE RemoteTask orchestration failure with ASRR1N42R01U31 (node pingable - True): A WebException occurred while sending a RestRequest. WebException.Status: ConnectFailure on [https://asrr1n42r01u31.n42r0108.masd.stbtest.microsoft.com:8888/CloudDefinition/ImportCloudParameters](https://asrr1n42r01u31.n42r0108.masd.stbtest.microsoft.com:8888/CloudDefinition/ImportCloudParameters).```  |The mitigation is to restart the DNS client service manually. On your server, go to the **Services manager**. Find the **DNS Client service**, right-click and select **Restart**.  |
