...
- **Deploy with assistance from FastTrack for Azure**: For guided assistance with Azure Stack HCI deployment projects, please consult your Microsoft Account team to leverage the FastTrack for Azure deployment acceleration program.  This program is available for select customers deploying Azure Stack HCI.  Please consult your account team for more information.
