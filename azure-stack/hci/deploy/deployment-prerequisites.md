---
title: Prerequisites to deploy Azure Local instance, version 23H2
description: Learn about the prerequisites to deploy Azure Local instance, version 23H2.
author: alkohli
ms.topic: conceptual
ms.date: 10/08/2024
ms.author: alkohli
