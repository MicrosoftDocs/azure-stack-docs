...
- Turn on Hyper-V Guest Service Interface: See the instructions [for WAC](/azure-stack/hci/deploy/azure-verification?tabs=wac#troubleshoot-vms) or for [PowerShell](/azure-stack/hci/deploy/azure-verification?tabs=azure-ps#troubleshoot-vms-1).
