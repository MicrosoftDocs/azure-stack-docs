...
| Update <!--26176875--> | When you attempt to change your AzureStackLCMUserPassword with command: `Set-AzureStackLCMUserPassword`, you might encounter this error: </br></br> *Cannot find an object with identity: 'object id'*.| There's no known workaround in this release. |
