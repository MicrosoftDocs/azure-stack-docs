...
:::image type="content" source="media/datacenter-firewall/overview-multitenant-firewall.png" alt-text="Screenshot of the Datacenter Firewall in the network stack" border.="false":::
