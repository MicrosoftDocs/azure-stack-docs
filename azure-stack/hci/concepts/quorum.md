---
title: HUnderstanding cluster and pool quorum on Azure Stack HCI
...
In Windows Server 2019, there are two components of the system that have their own quorum mechanisms:
