...
> [!IMPORTANT]
> **If you don't use DAX correctly, there is a high potential for data loss.** There are certain specific use cases for which using DAX is appropriate; however, it should always be used in conjunction with the block translation table (BTT) to enable block-like sector writes.
