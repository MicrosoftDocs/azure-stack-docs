...
The following PowerShell commands interact with the Enterprise Cloud Engine (ECE) to enable the selected modes.

> [!WARNING]
> ECE execution time will take up to 2~3 minutes to complete.
