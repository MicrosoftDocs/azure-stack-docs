...
If you are using Azure Stack HCI, version 23H2 (preview), the operating system updates are performed using Azure Update Manager. For more information, see [Use Azure Update Manager to update your Azure Stack HCI, version 23H2 (preview)](../update/azure-update-manager-23h2.md). To check for and install available firmware and driver updates use Windows Admin Center, see [Firmware and driver updates via Windows Admin Center](../update/azure-update-manager-23h2.md#firmware-and-hardware-updates-via-windows-admin-center).
