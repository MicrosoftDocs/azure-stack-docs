...
1. Make sure you have access to an Azure Local instance that is deployed and registered. During the deployment, an Arc Resource Bridge and a custom location are also created.
   ...
   Go to the resource group in Azure. You can see the custom location and Azure Arc Resource Bridge created for the Azure Local instance. Make a note of the subscription, resource group, and the custom location as you use these later in this scenario.

1. Make sure you have one or more Arc VMs running on this Azure Local instance. For more information, see [Create Arc VMs on Azure Local](./create-arc-virtual-machines.md).
...
When you enable guest management on an Arc VM, the guest agent installs the [Azure Connected Machine agent](/azure/azure-arc/servers/agent-overview). The Azure Connected Machine agent enables you to manage Azure Arc VM extensions on your Azure Local VM.
...
1. To verify whether the guest agent is running on the Arc VM, connect to the Azure Local machine.
...
1. Connect to one of the Azure Local machines. Run the following command to enable guest management.
...
1. Connect to Azure Local machine.
1. Run the following command:
...
1. Navigate to **Your Azure Local instance > Virtual machines** and then select the VM on which you enabled the guest management. 
...
Follow these steps in the Azure portal of your Azure Local instance to view VM properties.
...
Follow these steps in the Azure portal of your Azure Local instance to start a VM.
...
Follow these steps in the Azure portal of your Azure Local instance to stop a VM.
...
Follow these steps in the Azure portal of your Azure Local instance to restart a VM.
...
Follow these steps in the Azure portal of your Azure Local instance to change cores and memory.

1. Go to your Azure Local instance resource and then go to **Virtual machines**.
