...
1. Connect to the Server Manager Dashboard of the Windows Server.
    ...
    You can do this locally by using a keyboard and monitor, or using a remote management (headless or BMC) controller, or Remote Desktop. 
...
1. Log on to the server running Azure Stack HCI.
    ...
    You can do this locally by using a keyboard and monitor, or using a remote management (headless or BMC) controller, or Remote Desktop. The Server Configuration tool (Sconfig) opens automatically when you log on to the server.
