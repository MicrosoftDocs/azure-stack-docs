...
:::image type="content" source="media/import-export-vm-protection-key/verify-trusted-launch.png" alt-text="View VM properties to verify that the security type is "Trusted launch." border="false" lightbox="media/import-export-vm-protection-key/verify-trusted-launch.png":::
