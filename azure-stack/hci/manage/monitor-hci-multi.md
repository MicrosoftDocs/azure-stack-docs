...
3. [Enable Insights](/azure-stack/hci/manage/monitor-hci-single#enable-monitoring-visualizations) to allow Azure Monitor to start collecting the events that are required for monitoring.
