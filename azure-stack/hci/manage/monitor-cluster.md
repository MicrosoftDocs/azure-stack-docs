...
This article provides instructions about how to connect to an Azure Stack HCI cluster and monitor the cluster and storage performance using Windows Admin Center.
...
1. Select **Add** under **Server clusters** to add an Azure Stack HCI cluster:
    ...
    :::image type="content" source="media/monitor-cluster/choose-connection-type.png" alt-text="Choose Connection Type Screenshot" lightbox="media/monitor-cluster/choose-connection-type.png":::
...
:::image type="content" source="media/monitor-cluster/dashboard.png" alt-text="Windows Admin Center Dashboard Screenshot" lightbox="media/monitor-cluster/dashboard.png":::
...
To monitor VMs in Windows Admin Center, click **Virtual machines** from the **Tools** menu at the left.

:::image type="content" source="media/monitor-cluster/vms-summary.png" alt-text="Virtual Machine Summary" lightbox="media/monitor-cluster/vms-summary.png":::

To view a complete inventory of VMs running on the cluster, click **Inventory** at the top of the page. You'll see a table with information about each VM, including:
...
- **Disaster recovery status:** Shows whether the VM is signed into Azure Site Recovery.
    ...
    :::image type="content" source="media/monitor-cluster/vms-inventory.png" alt-text="Virtual Machine Inventory"  lightbox="media/monitor-cluster/vms-inventory.png":::
...
To monitor servers in Windows Admin Center, click **Servers** from the **Tools** menu at the left.

:::image type="content" source="media/monitor-cluster/servers-summary.png" alt-text="Servers Summary" lightbox="media/monitor-cluster/servers-summary.png":::

To view a complete inventory of servers in the cluster, click **Inventory** at the top of the page. You'll see a table with information about each server, including:
...
- **Memory usage:** The percentage of the host server's memory that is being utilized. If a server has less than 100MB of memory available for 10 minutes or longer, consider adding memory.
    ...
    :::image type="content" source="media/monitor-cluster/servers-inventory.png" alt-text="Servers Inventory" lightbox="media/monitor-cluster/servers-inventory.png":::
...
To monitor volumes in Windows Admin Center, click **Volumes** from the **Tools** menu at the left.

:::image type="content" source="media/monitor-cluster/volumes-summary.png" alt-text="Volumes Summary" lightbox="media/monitor-cluster/volumes-summary.png":::

To view a complete inventory of storage volumes on the cluster, click **Inventory** at the top of the page. You'll see a table with information about each volume, including:
...
- **IOPS:** Number of input/output operations per second.
    ...
    :::image type="content" source="media/monitor-cluster/volumes-inventory.png" alt-text="Volumes Inventory" lightbox="media/monitor-cluster/volumes-inventory.png":::
...
To monitor drives in Windows Admin Center, click **Drives** from the **Tools** menu at the left. 

:::image type="content" source="media/monitor-cluster/drives-summary.png" alt-text="Drives Summary" lightbox="media/monitor-cluster/drives-summary.png":::

To view a complete inventory of drives on the cluster, click **Inventory** at the top of the page. You'll see a table with information about each drive, including:
...
- **Storage usage:** The percentage of the drive's storage capacity that is being used.
    ...
    :::image type="content" source="media/monitor-cluster/drives-inventory.png" alt-text="Drives Inventory" lightbox="media/monitor-cluster/drives-inventory.png":::
...
:::image type="content" source="media/monitor-cluster/virtual-switch-settings.png" alt-text="Virtual Switch Settings" lightbox="media/monitor-cluster/virtual-switch-settings.png":::
