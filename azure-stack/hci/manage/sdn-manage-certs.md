...
> [!NOTE]
> For overview information about Network Controller, see [Network Controller](../concepts/network-controller-overview).
...
1. Assign the Users/Groups and a password for the certificate you are exporting, click **Next**.
