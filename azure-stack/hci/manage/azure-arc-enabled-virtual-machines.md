...
Please see the [Debugging section](https://docs.microsoft.com/azure-stack/hci/manage/azure-arc-enabled-virtual-machines#debugging) for common errors. If you are re-deploying the Arc Resource Bridge, please make sure to clean up the previous deployment completely following the [Uninstall procedure](https://docs.microsoft.com/azure-stack/hci/manage/azure-arc-enabled-virtual-machines#uninstall-azure-arc-resource-bridge).
