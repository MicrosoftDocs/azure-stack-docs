...
7. (Required only if AKS on Azure Stack HCI and Windows Server is not installed) Run the following cmdlet to uninstall the Microsoft on Cloud (MOC) service after testing:
