...
You need to set up certain variables when you run the uninstallation commands. For information about how to set up those variables, see [Set up Azure Arc VM management using command line](./deploy-arc-resource-bridge-using-command-line.md).

> [!IMPORTANT]
> Back up any running VMs before you uninstall Arc VM management. Uninstallation also removes these VMs.

Follow these steps to uninstall Azure Arc VM management:
