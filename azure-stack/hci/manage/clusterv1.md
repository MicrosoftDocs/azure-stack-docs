...
description: Learn how to manage Azure Stack HCI clusters
author: v-dasis
ms.topic: article
ms.type: how-to
ms.prod: 
...
Windows Admin Center can be used to manage your clusters in Azure Stack HCI. Specifically, you will be using the Cluster Manager extension in Windows Admin Center to manage your clusters, including for stretched clusters.
