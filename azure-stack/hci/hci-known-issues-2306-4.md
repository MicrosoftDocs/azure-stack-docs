...
This article applies to Azure Stack HCI, Supplemental Package, for 2306.4 patch update release. This release maps to software version number **10.2306.4.9**. This release supports only updating Azure Stack HCI deployments running 2306 Supplemental Package and later.

For more information, see [What's new in 23H2](whats-new.md) and [What's in preview](./manage/whats-new-2306-preview.md).
