...
|9|Environment Checker| If SSL inspection is turned on in your Azure Stack HCI system, the connectivity validator fails with the certificate validation error message.  | For information on how to troubleshoot the error, see [Troubleshoot connectivity validation](./manage/use-environment-checker.md#troubleshoot-connectivity-validation).|
