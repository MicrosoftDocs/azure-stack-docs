...
|7|OS update|After deployment, scanning for OS updates using SConfig or Cluster-Aware Updating may fail to scan Windows Update.|Remove the following registry key before attempting to scan for updates: `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\SystemCertificates\AuthRoot\AutoUpdate"RootDirUrl"="C:\\WuCTLFiles"`|