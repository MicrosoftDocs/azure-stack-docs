...
|8|Deployment|Cluster creation will fail with the error "Microsoft-Windows-Kerberos-Key-Distribution-Center Event ID 14 error event" in the System section of Event Log on your domain controller|Remove the following update [November 8, 2022—KB5019980 (OS Build 22621.819)](https://support.microsoft.com/help/5019980) from your domain controllers.|