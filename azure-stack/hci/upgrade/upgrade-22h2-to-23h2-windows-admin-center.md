...
1. The cluster's update status is displayed. Select **Check for updates** to get a list of the operating system updates available for each server in the cluster.
   ...
   You might need to supply administrator credentials. If no operating system updates are available, select **Next: Hardware updates** and proceed to step 8.
