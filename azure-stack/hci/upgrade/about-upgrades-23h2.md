...
| Stretch clusters on Azure Stack HCI     | No <br> When an upgrade becomes available for stretch cluster, you must upgrade to version 23H2 OS to maintain your cluster in a supported state. <br> The solution upgrade isn't available for stretched clusters.         |
