...
> - If running stretched clusters, you can only perform the version 23H2 OS upgrade. The solution upgrade is not supported on stretches clusters and will be blocked.
