...
> - If running stretched clusters, you can upgrade to version 23H2 OS and the upgraded cluster is supported. However, the solution upgrade is not supported on stretched clusters and will be blocked.
