...
hroughout this article, we refer to OS version 23H2 as the *new* version and version 22H2 as the *old* version.
...
1. [Connect to Azure Local, version 22H2.](#step-1-connect-to-the-azure-local-instance)
