...
|Solution Builder Extension (SBE)  | Bi-Annually | Solution Builder Extension updates provide driver, firmware, and other partner content specific to the system solution used. They might require host system reboots. |
