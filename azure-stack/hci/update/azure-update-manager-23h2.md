...
You can resume an update run if you see that a previous run failed. For more information, see [Resume an update](../update/update-troubleshooting-23h2.md#resume-an-update)
