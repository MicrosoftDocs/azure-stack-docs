...
[![Review and install hardware updates in Windows Admin Center.](./media/azure-update-manager/review-plus-install-2.png)](media/azure-update-manager/review-plus-install-2.png#lightbox)
