...
You can resume an update, if you see that a previous update run has failed. For more information, see [Resume an update](../update/update-troubleshooting-23h2.md#resume-an-update)
