...
|Update <!--26426548--> | When you update from the 2311 build to Azure Stack HCI 23H2, the update health checks stop reporting in the Portal UX after the update reaches the Install step. | Microsoft is actively working to resolve this issue, and there is no action required on your part. Although the health checks are not visible in the Portal UX, they are still running and completing as expected.|
