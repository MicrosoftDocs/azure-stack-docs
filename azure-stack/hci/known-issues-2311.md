...
|Update <!--26426548--> | When you update from the 2311 build to Azure Stack HCI 23H2, the update health checks stop reporting in the Portal UX after the update reaches the Install step. | The health checks continue to run and complete as expected although they aren't showing in the Portal UX |
