...
1. Select **Download and configure** in the **Before you begin replication...** information block.
...
1. (Optional) Select **Download installer** to download the appliance .zip file. Since the same bits are used for both source and target appliance, you can copy and reuse the .zip file you downloaded previously for the source appliance.
...
1. Create a new appliance virtual machine (VM) in the target cluster. Complete the **New Virtual Machine Wizard** with the following configuration:
...
1. Enter the code that is displayed in your Authenticator (or similar) app for MFA authentication.
    ...
    :::image type="content" source="./media/enter-code.png" alt-text="Screenshot showing the target key generated." lightbox="./media/enter-code.png":::
...
1. Enter cluster FQDN, domain, username, and password information, and then select **Configure**.
    ...
    :::image type="content" source="./media/add-cluster-info2.png" alt-text="Screenshot showing Add cluster information popup." lightbox="./media/add-cluster-info.png2":::

## Step 6: Start replication

1. In the Azure portal, go to your Azure Migrate project and select **Servers, databases and web apps**.

1. Select the **Step 1: Replicate** tile.
