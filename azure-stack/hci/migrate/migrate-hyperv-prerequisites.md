...
1. On the **Create project** page:
    ...
    1. Select the resource group, or create a new one if needed.
...
1. Under **Instance details**, follow these steps:
    ...
    1. Choose either **Standard** (recommended) or **Premium** performance.
    1. Select a redundancy level.
    1. Disable read access to data as needed. It is enabled by default.
