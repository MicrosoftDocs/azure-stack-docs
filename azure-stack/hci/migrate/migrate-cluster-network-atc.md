...
<!--Learn how to [Prepare to apply solution upgrade on Azure Stack HCI, version 23H2](../index.yml). -- need to update this to point to the Prepare to apply solution upgrade article-->