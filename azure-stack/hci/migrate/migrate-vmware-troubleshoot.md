---
title: Troubleshoot issues when migrating VMware VMs to Azure Stack HCI using Azure Migrate (preview)
description: Learn about how to troubleshoot issues when migrating VMware VMs to your Azure Stack HCI cluster using Azure Migrate (preview).
author: alkohli
ms.topic: how-to
ms.date: 04/09/2024
ms.author: alkohli
...
# Troubleshoot issues migrating VMware VMs to Azure Stack HCI via Azure Migrate (preview)

[!INCLUDE [applies-to](../../includes/hci-applies-to-23h2.md)]

This article describes how to troubleshoot any potential issues that you may experience when migrating VMware VMs to your Azure Stack HCI using Azure Migrate.

[!INCLUDE [important](../../includes/hci-preview.md)]

## Check if required services are running

Make sure that the VMware source appliance VM and the target appliance VM have a healthy configuration by ensuring the following services are running.
...
**On the VMware source appliance VM**:
...
If needed, Microsoft Support may also request component event viewer logs, or system event logs such as VMware logs and SMB logs.
