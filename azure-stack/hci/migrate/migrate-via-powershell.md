...
Once your new Azure Migrate project and associated source and target appliance are set up, you can initialize the replication infrastructure, create and update replications of the desired VMs, and then migrate them to your desired target location using Azure PowerShell.
