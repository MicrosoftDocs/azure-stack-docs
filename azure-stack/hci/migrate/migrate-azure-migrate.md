...
This article describes how to migrate the Hyper-V virtual machines (VMs) to Azure Local using Azure Migrate and includes the steps to verify the migration.
