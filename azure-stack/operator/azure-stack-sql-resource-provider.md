...
- In SQL management console, it is mandatory to define the Database name in connection properties. The user has limited privilege on the entire SQL Databases, and limited to their own database.
