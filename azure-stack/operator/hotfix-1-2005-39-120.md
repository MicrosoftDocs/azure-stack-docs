---
title: Azure Stack Hub hotfix 1.2005.39.120
description: Summary of Azure Stack Hub hotfix 1.2005.39.120
author: sethmanheim
...
# Azure Stack Hub hotfix 1.2005.39.120

## Summary

- Patched missing Hyper-V endpoint, allowing compute control plane operations to call the appropriate endpoint.
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2005.39.120/HotFix/AzS_Update_1.2005.39.120.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2005.39.120/HotFix/metadata.xml).
