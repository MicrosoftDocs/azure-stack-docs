...
> Additionally, during the **Register with Recovery Services vault** step, you're prompted to enter an **ASR replication appliance key**. You can generate this key from your Recovery Services vault in the target Azure Stack Hub portal by navigating to **Site Recovery vault > Protect workload > Set up a new replication appliance**.
