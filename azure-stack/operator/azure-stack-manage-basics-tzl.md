...
These services require additional configuration before you can make them available to your users. For more information, see **Tutorials** and **How-to guides** > **Offer services** in the [Azure Stack Hub operator documentation](/azure-stack/operator/).
...
You can use the [administrator portal](azure-stack-manage-portals.md) or PowerShell to manage Azure Stack Hub. The easiest way to learn the basic concepts is through the portal. If you want to use PowerShell, there are prerequisite steps. Before you get started, you might want to learn how PowerShell is used on Azure Stack Hub. 

Azure Stack Hub uses Azure Resource Manager as its underlying deployment, management, and organization mechanism. If you manage Azure Stack Hub and help support users, you should learn about Resource Manager. See the [Getting Started with Azure Resource Manager](https://download.microsoft.com/download/E/A/4/EA4017B5-F2ED-449A-897E-BD92E42479CE/Getting_Started_With_Azure_Resource_Manager_white_paper_EN_US.pdf) whitepaper.
...
- Add user accounts for [Azure AD](azure-stack-add-new-user-aad.md) deployment.
- [Set access permissions using role-based access control](azure-stack-manage-permissions.md). This task isn't restricted to admins.
...
- [Operate the extended storage](../user/azure-stack-network-howto-extend-datacenter.md).
- [Manage IoT Hub](/iot-hub/about-iot-hub).
- [Manage Event Hubs](event-hubs-rp-overview.md?toc=%2Fazure-stack%2Ftdc%2Ftoc.json&bc=%2Fazure-stack%2Fbreadcrumb%2Ftoc.json&view=azs-2002&branch=release-tzl).
- [Manage App Service](azure-stack-app-service-overview.md?toc=%2Fazure-stack%2Ftdc%2Ftoc.json&bc=%2Fazure-stack%2Fbreadcrumb%2Ftoc.json&view=azs-2002&branch=release-tzl).
- Replace bad hardware. Here is the list of [replaceable parts](azure-stack-replace-component.md).
- [Get support](azure-stack-help-and-support-overview.md?toc=%2Fazure-stack%2Ftdc%2Ftoc.json&bc=%2Fazure-stack%2Fbreadcrumb%2Ftoc.json&view=azs-2002&branch=release-tzl).
...
You'll need to let your users know how to work with services in Azure Stack Hub, how to connect to the environment, and how to subscribe to offers. In addition to any custom documentation that you may want to provide your users, you can direct users to [Azure Stack Hub User Documentation](/azure-stack/user/).
...
Your users want to know how to [access the user portal](../user/azure-stack-use-portal.md) or how to connect through PowerShell. In an integrated systems environment, the user portal URL varies per deployment. You'll need to provide your users with the correct URL.
...
To find support information for earlier releases of Azure Stack Hub (pre-1905), see [Azure Stack Hub servicing policy](azure-stack-servicing-policy.md).
...
If there's an issue with deployment, patch and update, hardware (including field replaceable units), or any hardware-branded software—like software running on the hardware lifecycle host, contact your OEM hardware vendor.
