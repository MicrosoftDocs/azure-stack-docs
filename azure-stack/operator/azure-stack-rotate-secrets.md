...
1. It's highly recommended that you first apply the latest available hotfix for the Azure Stack Hub version your instance is running. For example, if you are running 2008, make sure you have installed the [latest hotfix available](release-notes.md#hotfixes) for 2008.
