---
title: Azure Stack Hub hotfix 1.2005.34.108
description: Summary of Azure Stack Hub hotfix 1.2005.34.108
author: sethmanheim
...
# Azure Stack Hub hotfix 1.2005.34.108

## Summary

- Fixed an issue in which partner node certificates required by **nchotagent** might be deleted.
- Fixed VM NICs getting a different hardware identifier after VM is deallocated and restarted.
- Fixed an issue in which infrastructure VM deployment can fail after applying the hotfix.
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2005.34.108/HotFix/AzS_Update_1.2005.34.108.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2005.34.108/HotFix/metadata.xml).
