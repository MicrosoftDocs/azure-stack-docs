...
- Fixed a code defect that sometimes caused Health blades in the operator portal to become unavailable.
...
- Added NC IMOS size check to **Test-AzureStack**.
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2102.28.82/HotFix/AzS_Update_1.2102.28.82.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2102.28.82/HotFix/metadata.xml).
