...
- Run containers with [Azure Kubernetes Service (AKS) on Azure Stack HCI](../aks-hci/overview)
- Run Azure Arc enabled servies such as [Azure data services](/azure/azure-arc/data/overview.md), which inlcudes SQL Managed Instance and PostgreSQL Hyperscale, and [Azure enabled application services (preview)](/azure/app-service/overview-arc-integration.md), which inlcudes App Service, Functions, Logic Apps, API Management, and Event Grid.
