---
title: Create storage accounts in Azure Stack | Microsoft Docs
titleSuffix: Azure Stack
description: Learn how to create storage accounts in Azure Stack.
...
---
# Create storage accounts in Azure Stack
...
1. On the Azure Stack POC computer, sign in to `https://adminportal.local.azurestack.external` as [an admin](../asdk/asdk-connect.md), and then click **+ Create a resource** > **Data + Storage** > **Storage account**.
   ...
   ![Create your storage account in Azure Stack administrator portal](media/azure-stack-provision-storage-account/image01.png)
...
2. In the **Create storage account** blade, type a name for your storage account. Create a new **Resource Group**, or select an existing one, then click **Create** to create the storage account.
   ...
   ![Review your storage account in Azure Stack administrator portal](media/azure-stack-provision-storage-account/image02.png)

3. To see your new storage account, click **All resources**, then search for the storage account and click its name.

    ![Your storage account name in Azure Stack administrator portal](media/azure-stack-provision-storage-account/image03.png)
