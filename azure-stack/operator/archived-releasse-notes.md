---
title: Azure Stack archived release notes
description: Access the archived release notes for Azure Stack integrated systems, including what's new, known issues, and where to download the update.
...
This article provides access to the release notes and known issues, for archived releases. 
