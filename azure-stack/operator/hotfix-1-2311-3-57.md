---
title: Azure Stack Hub hotfix 1.2311.3.57
description: Summary of Azure Stack Hub hotfix 1.2311.3.57
author: sethmanheim
ms.topic: article
ms.date: 08/08/2024
ms.author: sethm
...
# Azure Stack Hub hotfix 1.2311.3.57
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2311.3.57/HotFix/AzS_Update_1.2311.3.57.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2311.3.57/HotFix/metadata.xml).
