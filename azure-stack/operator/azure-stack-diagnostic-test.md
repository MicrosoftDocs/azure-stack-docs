...
3. If any tests report **FAIL**, run `Get-AzureStackLog`. For instructions on an integrated system, see [To run Get-AzureStackLog on Azure Stack integrated systems](azure-stack-diagnostics.md#to-run-get-azurestacklog-on-azure-stack-integrated-systems), or on the ASDK, see [Run Get-AzureStackLog on an Azure Stack Development Kit (ASDK) system](azure-stack-diagnostics.md#run-get-azurestacklog-on-an-azure-stack-development-kit-asdk-system).
