...
To learn more about Azure Stack Hub diagnostics tools and issue logging, see [Azure Stack Hub Diagnostic log collection](/azure-stack/operator/diagnostic-log-collection).
