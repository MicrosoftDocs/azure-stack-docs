...
Similar to Azure, we recommend that you use the most up-to-date browser that's compatible with your operating system. For a list of Azure recommended browsers refer to [Recommended browsers](https://docs.microsoft.com/en-us/azure/azure-portal/azure-portal-supported-browsers-devices#recommended-browsers).
