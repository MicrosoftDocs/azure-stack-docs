...
After [deploying the Azure Stack Development Kit (ASDK)](../asdk/asdk-install.md), you need a tenant user account so you can explore the tenant portal and test your offers and plans. You can create a tenant account in Azure Active Directory (Azure AD) by [using the Azure portal](#create-an-azure-stack-tenant-account-by-using-the-azure-portal) or by using PowerShell.
