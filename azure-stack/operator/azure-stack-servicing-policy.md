...
- [Azure Stack Hub 2604 update](./release-notes.md?view=azs-2604&preserve-view=true)
...
For example, if the most recent update version available is 2604 (N), the two previous update versions were 2601 and 2506, which means both 2601 (N-1) and 2506 (N-2) remain in support. However, the 2501 (and earlier) version is out of support, as 2501 was N-3 when the 2604 update was released. For the current release of Azure Stack Hub, the following versions are considered in support:

- [Azure Stack Hub 2604](./release-notes.md?view=azs-2604&preserve-view=true)
