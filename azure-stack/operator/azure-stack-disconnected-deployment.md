...
|Containers|Impaired - Unable to import container images in disconnected mode from an Azure Container Registry in Azure public or another accessible registry. See FAQ entry at [Azure Container Registry on Azure Stack Hub](../azure-stack/user/container-registry-faq.md) for information on how to import container images in Azure Container Registry to a disconnected Azure Stack Hub deployment.
