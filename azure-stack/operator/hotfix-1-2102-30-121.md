---
title: Azure Stack Hub hotfix 1.2102.30.121
description: Summary of Azure Stack Hub hotfix 1.2102.30.121
author: sethmanheim
ms.topic: article
ms.date: 02/28/2022
ms.author: sethm
ms.reviewer: unknown
ms.lastreviewed: 02/28/2022

---

# Azure Stack Hub hotfix 1.2102.30.121
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.121/HotFix/AzS_Update_1.2102.30.121.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.121/HotFix/metadata.xml).
