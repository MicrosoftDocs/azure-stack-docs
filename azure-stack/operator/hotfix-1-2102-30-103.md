---
title: Azure Stack Hub hotfix 1.2102.30.103
description: Summary of Azure Stack Hub hotfix 1.2102.30.103
author: sethmanheim
ms.topic: article
ms.date: 09/14/2021
ms.author: sethm
ms.reviewer: unknown
ms.lastreviewed: 09/14/2021

---

# Azure Stack Hub hotfix 1.2102.30.103
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.103/HotFix/AzS_Update_1.2102.30.103.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.103/HotFix/metadata.xml).
