...
8.   Once the Quota set has been successfully created, you will receive a second notification. Now that the Compute service has a quota set it can be associated with a
