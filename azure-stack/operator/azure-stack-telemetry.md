---
title: Configure Azure Stack telemetry
titleSuffix: Azure Stack
description: Learn about Azure Stack telemetry and how to configure telemetry settings using PowerShell.
...
---
# Configure Azure Stack telemetry
