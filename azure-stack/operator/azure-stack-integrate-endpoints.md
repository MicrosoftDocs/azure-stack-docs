...
|**Telemetry**<br>Allows Azure Stack Hub to send telemetry data to Microsoft.|`https://settings-win.data.microsoft.com`<br>`https://login.live.com`<br>`*.events.data.microsoft.com`<br>`https://*.blob.core.windows.net/`<br>`https://azsdiagprdwestusfrontend.westus.cloudapp.azure.com/` | HTTPS 443 | Public VIP - /27 | Required when Azure Stack Hub telemetry is enabled. |
