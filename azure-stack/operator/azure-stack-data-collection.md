...
As Azure Stack Hub resides in customer datacenters, Microsoft is the Data Controller solely of the data that is shared with Microsoft through [Diagnostics](./azure-stack-diagnostic-log-collection-overview.md?view=azs-2002), [Telemetry](azure-stack-telemetry.md), and [Billing](azure-stack-usage-reporting.md).  
...
## Diagnostic data
As part of the support process, Azure Stack Hub Operators can [share diagnostic logs](./azure-stack-diagnostic-log-collection-overview.md?view=azs-2002) with Azure Stack Hub support and engineering teams to help with troubleshooting.
