...
- Cause: Neither of the [newly introduced ESv3 or DSv3 series](../user/azure-stack-vm-sizes.md#esv3-series) (for example, E20s_v3) have nested virtualization enabled.
- Remediation: Microsoft is aware of the issue and is working on a fix.
- Occurrence: Common.
