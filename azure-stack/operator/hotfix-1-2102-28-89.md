...
- Fixed bugs in ADFS and Azure Stack Graph that improve deployment and upgrade reliability.
- Fixed bugs in SRP and DiskRP in which performance counters were missing in WAC client.
