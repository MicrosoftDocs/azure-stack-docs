...
8. Optionally, you can enable [automated diagnostic log collection](azure-stack-configure-automatic-diagnostic-log-collection.md) to proactively collect logs for customer support analysis if the update fails with an alert such as **Update failed**. 
