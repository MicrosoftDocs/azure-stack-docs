...
Use **ExpireInMinutes** parameter to set the duration of the session. In the example, consent expires in one day. After one day, remote access cannot be established.
