...
| [Access PEP](/azure-stack/operator/azure-stack-privileged-endpoint)                                     | Log collection and upload:<br>-[Create an SMB share](&preserve-view=true) on the HLH for file transfer from Azure Stack Hub.<br>-Use Azure Storage Explorer to upload logs saved to the SMB share. |
