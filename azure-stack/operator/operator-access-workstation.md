...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Access the Administration portal](./azure-stack-manage-portals.md&preserve-view=true)                    | Perform administrative operations.                                                                                                                                                                                                                                                                                       |
| [Access PEP](./azure-stack-privileged-endpoint.md&preserve-view=true)                                     | Log collection and upload:<br>-[Create an SMB share](&preserve-view=true) on the HLH for file transfer from Azure Stack Hub.<br>-Use Azure Storage Explorer to upload logs saved to the SMB share. |
| [Register Azure Stack Hub](./azure-stack-registration.md&preserve-view=true) | For re-registration, get previous Registration Name and Resource Group from the Administration portal.                                                                                                                                                                                                                   |
| [Marketplace syndication](./azure-stack-download-azure-marketplace-item.md&preserve-view=true)            | [Create an SMB share](&preserve-view=true) on the HLH to store the downloaded image or extension.                                                                                                     |
| [Create Virtual Machines](../user/azure-stack-quick-create-vm-windows-cli.md&preserve-view=true)                    | Create virtual machines using Azure CLI.                                                                                                                                                                                                                                                                                       |
| [Manage AKS](../user/azure-stack-kubernetes-aks-engine-scale.md&preserve-view=true)                                 | Manage AKS clusters, for example,  scale or upgrade.                                                                                                                                                                                                                                                                        |
...
| [Az Modules](./powershell-install-az-module.md&preserve-view=true) | [SystemDrive]\\ProgramFiles\\WindowsPowerShell\\Modules              |
