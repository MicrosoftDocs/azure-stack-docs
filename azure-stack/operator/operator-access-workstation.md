...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Access the Administration portal](/azure-stack/operator/azure-stack-manage-portals)                    | Perform administrative operations.                                                                                                                                                                                                                                                                                       |
| [Access PEP](/azure-stack/operator/azure-stack-privileged-endpoint)                                     | Log collection and upload:<br>-[Create an SMB share](/azure-stack/operator/azure-stack-privileged-endpoint) on the HLH for file transfer from Azure Stack Hub.<br>-Use Azure Storage Explorer to upload logs saved to the SMB share. |
| [Register Azure Stack Hub](/azure-stack/operator/azure-stack-registration) | For re-registration, get previous Registration Name and Resource Group from the Administration portal.                                                                                                                                                                                                                   |
| [Marketplace syndication](/azure-stack/operator/azure-stack-download-azure-marketplace-item)            | [Create an SMB share](/azure-stack/operator/azure-stack-download-azure-marketplace-item) on the HLH to store the downloaded image or extension.                                                                                                     |
| [Create Virtual Machines](/azure-stack/user/azure-stack-quick-create-vm-windows-cli)                    | Create virtual machines using Azure CLI.                                                                                                                                                                                                                                                                                       |
| [Manage AKS](/azure-stack/user/azure-stack-kubernetes-aks-engine-scale)                                 | Manage AKS clusters, for example,  scale or upgrade.                                                                                                                                                                                                                                                                        |
...
| [Az Modules](/azure-stack/operator/powershell-install-az-module) | [SystemDrive]\\ProgramFiles\\WindowsPowerShell\\Modules              |
