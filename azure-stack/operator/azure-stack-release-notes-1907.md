...
- Fixed an issue in where a user with **Read only** permissions was able to create/edit/delete resources. Now the user will only be able to create resources when the **Contributor** permission is assigned. 
