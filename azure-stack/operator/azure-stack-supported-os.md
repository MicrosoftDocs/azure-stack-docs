...
Azure Stack supports the Windows guest operating systems that are listed in the following table. Windows client images are not available in the Marketplace.
