---
title: Azure Stack Hub hotfix 1.2102.30.119
description: Summary of Azure Stack Hub hotfix 1.2102.30.119
author: sethmanheim
ms.topic: article
ms.date: 01/13/2022
ms.author: sethm
...
# Azure Stack Hub hotfix 1.2102.30.119
...
- Fixed an issue in which the **PrivateWorkingSet** queried value overflows if larger than 4GB.
- Removed some unnecessary detailed error information on the administrator portal.
- Improvements to support tools.
- Resolved an issue with some keyvault applications being in an unhealthy state while updating from 2102 to later builds.
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.119/HotFix/AzS_Update_1.2102.30.119.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.119/HotFix/metadata.xml).
