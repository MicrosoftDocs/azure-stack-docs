...
- A new version of the Azure Stack Hub admin REST API is available. You can find details about endpoints and breaking changes in the [API Reference](https://docs.microsoft.com/en-us/rest/api/azure-stack/).
