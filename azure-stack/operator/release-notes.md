...
Fixed an issue that caused the system to raise an alert for AAD Home Directory needs to be configured
Fixed an issue that prevent the alert for AAD Home Directory needs to be configured not to close automatically
