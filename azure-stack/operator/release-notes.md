...
- Azure Container registries Public Preview is now available in Azure Stack Hub starting with this version. Operators will now be able to optionally enable the service and include it as part of tenants plans. Tenant users will be able to create and manage ACR registries using the Azure ACR User Interface, Command Line Interface, PowerShell, API, and ARM templates. To learn more review the [Operator](https://aka.ms/ash-acr-operator-docs) and [User](https://aka.ms/ash-acr-docs) documentation.
...
- [Azure Stack Hub hotfix 1.2008.40.153](hotfix-1-2008-40-153.md)
