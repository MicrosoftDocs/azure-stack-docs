...
-The AzSScenarios suite of Test-AzureStack validation tool has been updated to enable the Cloud Service Providers to run this suite successfully with multi-factor authentication enforced on all customer accounts.
...
You can download the Azure Stack Hub 2008 update package from [the Azure Stack Hub download page](https://aka.ms/azurestackupdatedownload).
