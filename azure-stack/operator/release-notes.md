...
::: moniker-end
> [!IMPORTANT]  
> If your Azure Stack Hub instance does not have an active support contract with the hardware partner, it's considered out of compliance. You must [have an active support contract for the hardware](azure-stack-servicing-policy.md#keep-your-system-under-support).
::: moniker-end
