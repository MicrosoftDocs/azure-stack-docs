...
- We now support adding GPUs to an existing system - This will need the system to be shutdown, GPUs added and then start-azurestack will need to be run. Any prior created GPU VMs will need to be stop-deallocated and started.
