...
> [!IMPORTANT]  
> Microsoft is temporarily extending our [Azure Stack Hub support policy statements](azure-stack-servicing-policy.md). We are working with customers around the world who are responding to COVID-19 and who may be making important decisions about their Azure Stack Hub systems, how they are updated and managed, and as a result, ensuring their data center business operations continue to operate normally. In support of our customers, Microsoft is offering a temporary support policy change extension to include three previous update versions for an additional 45 days after release. As a result, the newly released 2005 update and any one of the three previous update versions (2002, 1910, and 1908) will be supported. After these 45 days, we will return to our standard support policy, meaning the supported versions will then be 2005, 2002 and 1910.
...
- This build offers support for 3 new GPU VM types: NCv3 (Nvidia V100), NVv4 (AMD Mi25), and NC_T4 (NVIDIA T4) VM sizes. VM deployments will be successful for those who have the right hardware and are onboarded to the Azure Stack Hub GPU preview program. If you are interested, sign up for the GPU preview program at https://aka.ms/azurestackhubgpupreview.
