...
- The Azure Stack Hub admin portal does now block certain operations if a system operation is already in progress. For example if an update is in progress it will not be possible to add a new scale unit node.
