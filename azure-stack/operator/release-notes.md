...
- Azure Stack Hub now supports adding GPUs to an existing system. This requires the system to be shut down, GPUs added, and then run **start-azurestack**. Any previously created GPU VMs will need to be **stop-deallocated** and then re-started.
