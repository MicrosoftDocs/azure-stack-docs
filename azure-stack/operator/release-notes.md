...
- [**AzureStack** module 2.2.0](/powershell/azure/azure-stack/overview?view=azurestackps-2.2.0) is released to align with Azure Stack Hub version 2108. The module includes updates to compute administrator and module of cmdlets for the Azure Stack Hub Container Registry Service.
