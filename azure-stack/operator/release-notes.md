...
- The [Java SDK](https://azure.microsoft.com/develop/java/) released new packages due to a breaking change in 2002. Users must install the new Java SDK dependency. The Java SDK released new packages due to breaking change in 2002 because of TLS restrictions. Users must install the new Java SDK dependency. You can find the instructions at: [Java and API version profiles](https://docs.microsoft.com/azure-stack/user/azure-stack-version-profiles-java?view=azs-1910#java-and-api-version-profiles).
