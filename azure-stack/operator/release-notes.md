...
- This update contains changes to the update process that will significantly improve the performance of future Full Updates. These changes will take effect the next Full Update **after** the 2002 release. These changes will specifically target improving the performance of the phase of a Full Update in which host operating systems are updated. Improving the performance of host operating system updates will significantly reduce the window of time for which tenant workloads may be impacted during Full Updates.
