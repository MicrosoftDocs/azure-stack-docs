...
- With 2311 we are announcing the public preview of the Azure Stack Hub [Standard Load Balancer](https://learn.microsoft.com/azure-stack/user/standard-load-balancer-considerations). This feature enables several scenarios: allowing standalone VMs to be in a backend pool, HTTPS probes, high-availability ports, and TCP reset on idle.
