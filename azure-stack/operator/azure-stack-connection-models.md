...
description: Determine connection models and other deployment planning decisions for Azure Stack integrated systems.
...
After you've decided on the Azure connection model to be used for your Azure Stack deployment, additional connection-dependent decisions must be made for the identity store and billing method.
