...
> [!NOTE]
> MySQL databases should be be created on the MySQL resource provider server. The MySQL resource provider should be created in the default provider subscription while MySQL hosting servers should be created in a billable, user subscription. The resource provider server should not be used to host user databases.
