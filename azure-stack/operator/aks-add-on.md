...
> [!IMPORTANT]  
> Azure Kubernetes Service on Azure Stack Hub is currently in PREVIEW and is being discontinued. Please check out [AKS Engine](https://learn.microsoft.com/en-us/azure-stack/user/azure-stack-kubernetes-aks-engine-overview?view=azs-2206) for a Kubernetes solution on Azure Stack Hub. 
