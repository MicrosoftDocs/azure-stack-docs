---
title: Azure Stack Hub hotfix 1.2102.30.111
description: Summary of Azure Stack Hub hotfix 1.2102.30.111
author: sethmanheim
ms.topic: article
ms.date: 11/18/2021
ms.author: sethm
ms.reviewer: unknown
ms.lastreviewed: 11/18/2021

---

# Azure Stack Hub hotfix 1.2102.30.111
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.111/HotFix/AzS_Update_1.2102.30.111.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_ProdHotfix_1.2102.30.111/HotFix/metadata.xml).
