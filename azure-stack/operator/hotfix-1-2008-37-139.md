---
title: Azure Stack Hub hotfix 1.2008.37.139 
description: Summary of Azure Stack Hub hotfix 1.2008.37.139
author: sethmanheim
...
- Configured stamp ADFS to monitor corp ADFS signing certificate rollover. This is for Azure Stack Hub with ADFS identity systems when Azure Stack Hub is configured with corp ADFS and a federation metadata endpoint.
...
[Download the zip file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2008.37.139/HotFix/AzS_Update_1.2008.37.139.zip).

[Download the hotfix xml file now](https://azurestackhub.azureedge.net/PR/download/MAS_HotFix_1.2008.37.139/HotFix/metadata.xml).
