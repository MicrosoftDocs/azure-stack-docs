...
3. Open PowerShell with an elevated prompt, and run:
   ...
   - **version**  
     ...
     For more info about the **Remove-AzsPlatformImage** cmdlet, see the Microsoft PowerShell [Azure Stack Hub Operator module documentation](/azure-stack/operator).
