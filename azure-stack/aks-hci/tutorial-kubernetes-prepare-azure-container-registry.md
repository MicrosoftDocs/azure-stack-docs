---
title: Tutorial - Create container registry to use in AKS hybrid deployments
...
In later tutorials, this ACR instance is integrated with a Kubernetes cluster in Azure Kubernetes Server (AKS) hybrid, and an application is deployed from the image.
