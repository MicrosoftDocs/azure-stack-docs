---
title: Quickstart to set up an Azure Kubernetes Service host and create AKS on Azure Stack HCI and Windows Server clusters using Windows PowerShell
description: Learn how to set up an Azure Kubernetes Service host and create AKS on Azure Stack HCI and Windows Server clusters using Windows PowerShell.
author: mattbriggs
ms.topic: quickstart
ms.date: 05/02/2022
ms.author: mabrigg 
...
# Intent: As an IT Pro, I want to create AKS on Azure Stack HCI and Windows Server using Windows PowerShell.
...
- Use **at least one** of the following:
   - Azure Stack HCI or Windows Server cluster
   - Windows Server 2019/2022 Datacenter failover cluster
   > [!NOTE]
   > **We recommend having an Azure Stack HCI or Windows Server cluster.** If you don't have any of the above, follow instructions on the [Azure Stack HCI registration page](https://azure.microsoft.com/products/azure-stack/hci/hci-download/).
...
After installing your AKS host, you are ready to deploy a Kubernetes cluster. Open PowerShell as an administrator and run the following [New-AksHciCluster](./reference/ps/new-akshcicluster.md) command. This example command will create a new Kubernetes cluster with one Linux node pool named *linuxnodepool* with a node count of 1. To read more information about node pools, visit [Use node pools in AKS on Azure Stack HCI and Windows Server](use-node-pools.md).
