...
Microsoft engineering has tested these configurations. If you want to exceed the tested configurations, see [Scaling AKS hybrid on Azure Stack HCI](#scaling-aks-on-azure-stack-hci).
