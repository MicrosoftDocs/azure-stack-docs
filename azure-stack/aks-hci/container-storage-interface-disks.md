...
>  - For version Kubernetes 1.20 and above, create a custom storage class with [fsGroupPolicy:File](https://kubernetes-csi.github.io/docs/support-fsgroup.html).
>  - For version Kubernetes 1.19, include the parameter `fsType: ext4`.
