...
The cluster removal process will hang until `kvactl.exe` times out. However, when using the AKS on Azure Stack HCI August release or later, this timeout does not occur. 
