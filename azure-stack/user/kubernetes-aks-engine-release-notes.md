...
To use AKS engine 0.71.0:
 ...
 - **If you're using storage volumes**:  
    Make sure that you're using the AzureDiskCSI driver. Version 0.70.0 only supports CSI drivers, not the legacy *in-tree* storage provider. To upgrade, follow the instructions to [upgrade from Kubernetes v1.20 to v1.21](https://learn.microsoft.com/en-us/azure-stack/user/azure-stack-kubernetes-aks-engine-upgrade?view=azs-2206#steps-to-update-cluster-using-storage-volumes).
