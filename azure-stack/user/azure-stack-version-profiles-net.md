...
- To use the services compatible with Azure Stack Hub, use one of the following packages:
  ...
  > [!NOTE] API Profile 2020_09_01 is now available as a [NuGet package](https://www.nuget.org/packages?q=Microsoft.Azure.Management.Profiles.hybrid_2020_09_01). Change the profile date to `_2020_09_01`.
