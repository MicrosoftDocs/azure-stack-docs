...
![Azure environments](./media/azure-stack-arm-azure-and-azure-stack/environments.png)
...
For an introduction to Azure Resource Manger templates, see [Template deployment]https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview#template-deployment).

## Ensure template functions work

The basic syntax of a Resource Manager template is JSON. Templates use a superset of JSON, extending the syntax with expressions and functions. The template language processor is frequently updated to support additional template functions. For a detailed explanation of the available template functions, see [Azure Resource Manager template functions](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-template-functions).
...
![Resource providers](./media/azure-stack-arm-azure-and-azure-stack/resource-providers.png) 
...
You can also execute the Azure PowerShell [Get-AzureRmVmImagePublisher](https://docs.microsoft.com/powershell/module/az.compute/get-azvmimagepublisher) cmdlet and use `-Location` to specify the location of the virtual machine image. For example:
...
To retrieve a list of the available API versions for the VM extension resource, use the [Get-AzureRmResourceProvider](https://docs.microsoft.com/powershell/module/az.resources/get-azresourceprovider) cmdlet with the **Microsoft.Compute** resource provider as shown:
...
To retrieve a list of the available versions for a specific VM extension, use the [Get-AzureRmVMExtensionImage](https://docs.microsoft.com/powershell/module/az.compute/get-azvmextensionimage) cmdlet. The following example retrieves the available versions for the PowerShell DSC (Desired State Configuration) VM extension from **myLocation**:

```azurepowershell-interactive
Get-AzureRmVMExtensionImage -Location myLocation -PublisherName Microsoft.PowerShell -Type DSC | FT
```

To get a list of publishers, use the [Get-AzureRmVmImagePublisher](https://docs.microsoft.com/powershell/module/az.compute/get-azvmimagepublisher) command. To request type, use the [Get-AzureRmVMExtensionImageType]https://docs.microsoft.com/powershell/module/az.compute/get-azvmextensionimagetype) commend.
...
![Workflow](./media/azure-stack-arm-azure-and-azure-stack/workflow.png) 
...
* [Azure Resource Manager template considerations](https://docs.microsoft.com/azure/azure-stack/user/azure-stack-develop-templates)