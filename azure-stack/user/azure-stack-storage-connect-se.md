...
> [!NOTE]  
> Azure Storage Explorer relies on NodeJS networking stack for determining which default certificate signers to trust.  [Learn more](\azure\storage\common\storage-explorer-network#ssl-certificates).
