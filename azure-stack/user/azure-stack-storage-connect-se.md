...
> [!NOTE]  
> Azure Storage Explorer relies on NodeJS networkign stack for determining which default certificate signers to trust. [Learn more](https://docs.microsoft.com/en-us/azure/storage/common/storage-explorer-network#ssl-certificates).
