...
| Internal Load Balancer | Frontend IP | No limit. | Azure Stack Hub provides an IP pool of 127 IPs for the internal load balancer's front end IPs. A small subset of that IP pool is used for its internal infrastructure. |
