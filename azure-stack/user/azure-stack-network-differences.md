...
|  | VPN Gateway SKUs | Support for Basic, GW1, GW2, GW3, Standard, High Performance, Ultra-High Performance. | Support for Basic, Standard, High Performance, VpnGwy1, VpnGwy2, VpnGwy3. <br> Ultra-High Performance is not supported. <br> Azure Stack VPN Fast Path is supported. See [New virtual network gateways SKUs available](azure-stack-vpn-fast-path-user.md#new-virtual-network-gateways-skus-available-when-vpn-fast-path-is-enabled). |
