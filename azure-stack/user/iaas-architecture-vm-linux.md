---
title: Run a Linux virtual machine on Azure Stack | Microsoft Docs
description: Learn how to run a Linux virtual machine on Azure Stack.
...
# Run a Linux virtual machine on Azure Stack
...
The VM is created with a temporary disk. This disk is stored on a temporary volume on the Azure Stack storage infrastructure. It may be deleted during reboots and other VM lifecycle events. Use this disk only for temporary data, such as page or swap files. For Linux VMs, the temporary disk is /dev/sdb1 and is mounted at /mnt/resource or /mnt.
