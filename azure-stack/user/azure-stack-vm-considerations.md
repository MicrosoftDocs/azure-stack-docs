...
| SAP workload certification | Azure supports [SAP workload certifications](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-certifications), including HANA, NetWeaver, and others. | Azure Stack Hub hardware does not support certification of any SAP workloads. |
