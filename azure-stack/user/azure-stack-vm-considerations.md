...
| SAP workload certification | Azure supports [SAP workload certifications](/azure/virtual-machines/workloads/sap/sap-certifications.md), including HANA, NetWeaver, and others. | Azure Stack Hub hardware does not support certification of any SAP workloads. |
