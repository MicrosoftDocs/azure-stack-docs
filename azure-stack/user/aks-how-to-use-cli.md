...
2.  Make sure you have a service principal ID ready with contributor permission on your subscription to create clusters in it.
    ...
    3.  To assign "Contributor" role to the SPN see [instructions](../operator/azure-stack-create-service-principals.md#assign-a-role). Make sure to select the "Contributor" role.
