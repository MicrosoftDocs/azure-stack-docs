...
2.  Make sure you have a service principal ID ready with contributor permission on your subscription to create clusters in it.
    1.  To create a service principle (SPN) using Azure Active Directory (Azure AD), follow these [instructions](/azure-stack/operator/azure-stack-create-service-principals?&preserve-view=true#create-a-service-principal-that-uses-a-client-secret-credential).
    2.  To create an SPN using Active Directory Federated Services (AD FS), follow these [instructions](/azure-stack/operator/azure-stack-create-service-principals?&preserve-view=true#create-a-service-principal-that-uses-client-secret-credentials).
    3.  To assign "Contributor" role to the SPN see [instructions](/azure-stack/operator/azure-stack-create-service-principals?view=azs-2005#assign-a-role&preserve-view=true). Make sure to select the "Contributor" role.
