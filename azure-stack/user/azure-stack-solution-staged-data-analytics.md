...
4.  Select **Create to create the storage account**.
    ...
    ![Create storage account in Azure Stack](media/azure-stack-solution-staged-data-analytics/image1.png)
...
7.  At the top of the blade, select **+ Container.** and select **Container**.
    ...
    ![Select container in Azure Stack](media/azure-stack-solution-staged-data-analytics/image2.png)
...
![View new function app](media/azure-stack-solution-staged-data-analytics/image8.png)
...
1.  Create a new function by clicking on **Functions**, then the **+New Function** button.
    ...
    ![Create a new function](media/azure-stack-solution-staged-data-analytics/image3.png)

2.  Select **Timer Trigger**.

    ![Timer trigger for new function](media/azure-stack-solution-staged-data-analytics/image4.png)
...
3.  Select **C\#** as the language and name the function: `upload-to-azure`.  Set the schedule to `0 0 * * * *`, which in CRON notation is once an hour.
    ...
    ![New function settings](media/azure-stack-solution-staged-data-analytics/image5.png)
