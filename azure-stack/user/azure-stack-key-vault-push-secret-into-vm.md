...
> [!NOTE]
> You can use these steps from the Azure Stack Development Kit (ASDK), or from an external client if you are connected through VPN.
...
Azure Stack pushes the certificate to the virtual machine during deployment. The certificate location depends on the operating system of the VM:
