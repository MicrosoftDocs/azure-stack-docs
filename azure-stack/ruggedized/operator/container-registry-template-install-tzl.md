...
| Item | Type | Details |
| --- | --- | --- |
| Azure Stack Hub PowerShell modules (../../operator/azs.Gallery.Admin) | PowerShell Modules | Only required if side loading the container registry template gallery item, the Azure Stack Hub PowerShell Modules are used to add and remove gallery items.<br>[Install Azure Stack PowerShell modules](../../operator/azure-stack-powershell-install.md) |
