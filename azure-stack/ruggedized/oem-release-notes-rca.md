...
# Azure Stack Hub Ruggedized 2.2.2108.4 OEM release notes
...
| Release version | Driver version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2.2.2108.4, 2102, 2008  | 2.40.22511.0  | Initial solution version  |
...
| 2.2.2108.4, 2102  | 25.5.8.0001  | - Enhanced Background Initialization (BGI) and Consistency Check (CC) progress to reduce performance impact when progress is saved (checkpointed).  |
...
| 2.2.2108.4  | 1.13.104.0  | - Resolved an issue on Windows OSs where using "Identify Adapter" under X710 based adapters' Adapter Properties in Device Manager does not blink the adapter LEDs.  |
...
| 2.2.2108.4, 2102  | 9.14.2.9  | - Updated to Dell recommended version<br/><br/>- Sev 3 issue fix - avoid potential software exception at bootup<br/><br/>- Sev 2 issue fix - PSU serial not showing in inventory.  |
