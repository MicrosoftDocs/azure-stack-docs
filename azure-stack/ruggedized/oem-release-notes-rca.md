...
# Azure Stack Hub Ruggedized 2206 OEM release notes
...
| 2206    | 07/12/2022 | 2.2.2206.10 OEM package updates|
...
|-----------------|------------------|----------------------------------------|
| 2206, 2008, 2102, 2108, 2112  | 2.5.13.3024  | Initial solution version  |

### Capacity Drive Controller - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2008, 2102, 2108, 2112  | 16.17.01.00  | Initial solution version  |

| Release version | Driver version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2008, 2102, 2108, 2112  | 2.51.25.02  | Initial solution version  |

### Chipset - Azure Stack Hub

| Release version | Driver version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2008, 2102, 2108, 2112  | 10.1.9.2  | Initial solution version  |

### Dell uEFI Diagnostics - Azure Stack Hub

| Release version | Application version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206  | 4301A66  | Enhancements: Changes to support new hardware.  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206  | 5.10.10.00  | Fixes:<br/>-VNC Vconsole keyboard layout issue in Japanese language<br/>-Mellanox CX-4 port flapping in LCLOG<br/>-Fixed a issue with snmp racName racShortName were incomplete<br/>-Sound cap thermal profile is not available on IDRAC HII<br/>-Fixed an issue with Intermittent iDRAC watchdog reset occurring<br/>-Fixed issue to see the pending values from Racadm when trying to change the uefibootseq<br/><br/>iDRAC firmware Enhancements:<br/>-Support to display board details (Part number, Serial number, Manufacturing date, and Hardware Revision) for various updated networking adapters<br/>-Rebootless updates for NVMe drive (SK-Hynix PE8010 and later versions).<br/>-Disk "warning" in System Event Log (SEL).<br/>-Support for 15 users in LDAP group.<br/>-Discover and report NUMA topology (CPU affinity) of the system.<br/><br/>Automationï¿½API and CLI Enhancments:<br/>-API support for PSU redundancy control.<br/>-Support for Redfish 2019.3, 2019.4, 2020.1, and 2021.2 updates.<br/>-IPv6 enabled by default.<br/>-Ability to monitor PSU input power from systems management CLI tools.<br/>-Support for new triggers.<br/>-Support for extended CPU metrics.<br/>-Support for Influx DB reference design example.<br/>-Command to query and set the PSU 1+1 redundancy state.<br/><br/>Security Enhancements: <br/>-Support for TLS 1.3 with FIPS.<br/>-Support for SMART log files for SATA HDDs.<br/>-Support for iDRAC Local Key Management (iLKM).  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2112  | DL6R  | Initial solution version.<br/><br/>Fixes:<br/>-SMART attribute shift solution<br/>-MRR settings to mitigate BJ004 issue<br/>-Fix for drive stops responding after soft-reboot following windows install  |
| 2206, 2112  | DL6R  | Initial solution version.<br/><br/>Fixes:<br/>-SMART attribute shift solution<br/>-MRR settings to mitigate BJ004 issue<br/>-Fix for drive stops responding after soft-reboot following windows install  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2112  | DL70  | Initial solution version  |

### Intel S3520 boot - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2112  | DL43  | Initial solution version<br/><br/>Fixes:<br/>-Numerous minor bug fixes<br/>-Fix for some M.2 drives not upgrading<br/><br/>Enhancements:<br/>-Added support for Instant Scramble Erase commands  |

### Micron 5100 M.2 480GB & 960GB - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2108, 2112  | E013  | Fixes:<br/>- Remove monitoring of 12V power bus, to improve drive stability in noisy 12V power conditions.<br/>- Improve wear leveling algorithms, to recover cleanly from power cycles and manage high write workloads better.<br/>- Fix to R_ERR handling, to eliminate case where high frequency of CRC errors may cause the drive to enter bus hang state.  |

### Micron 5300 - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2008, 2102, 2108, 2112  | D3MS402  | Initial solution version  |

### Micron 5300 boot - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2112  | J004  | Initial solution version  |

### NIC - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206  | 14.32.20.04  | Latest Dell recommended version for Azure Stack Hub as of April 2022.  |
...
| Release version | Driver version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206  | 2.80.25134.0  | Latest Dell recommended version for Azure Stack Hub as of April 2022.  |
...
|-----------------|------------------|----------------------------------------|
| 2206  | 2.14.2  | Fixes:<br/>- Fixed an issue where iDRAC9 UI will allow end-user to define valid IPv6 BIOS Network HTTP URI values with common IPv6 address schemes.<br/>- Fixed an issue where system can perform HTTPS boot to SLES SP3.<br/>- Remove unsupported Software Prefetcher option from setup menu.<br/><br/>Enhancements:<br/>- Added enhancements to address the security vulnerabilities (Common Vulnerabilities and Exposures - CVE) such as CVE-2021-0159, CVE-2021-0189, CVE-2021-21131, CVE-2021-33123, CVE-2021-33124, CVE-2021-33159, CVE-2022-21166.<br/>- Updated the "Processor and Memory Reference Code" for the second-generation Intel Xeon Processor Scalable Family to IPU 2022.1.<br/>- Updated the Processor Microcode to version 0x3302 for the second-generation Intel Xeon Processor Scalable Family.<br/>- Updated the Processor Microcode to version 0x6D05 for the Intel Xeon Processor Scalable Family.<br/>- Updated SPS to SPS_E5_04.01.04.700.0 (IPU 2022.1) for Purley Refresh.<br/>- Added Virtual Network File 2 support.<br/>- Enhanced the capability for supporting complex PCIe device.<br/>- Updated the SMBIOS baseboard and chassis information in BIOS for Dell Precision R7920 Rack Workstation only.<br/>- Change memory "Correctable Error Logging" default to Disabled.<br/>- No log for DIMM self-healing status message for Uncorrectable Memory Error.<br/>- Added new BIOS setup option to disable PPR with Uncorrectable Error.<br/>- Updated the S140 Software RAID firmware to version 5.7.0-0006.<br/>- Enhancement to address the security vulnerabilities (Common Vulnerabilities and Exposures - CVE) such as CVE-2021-28211, CVE-s2021-28210.  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2108, 2112  | 1.0.6  | Fixes:<br/>-Addresses a possibility of IDRAC not responding during PSU firmware update.  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2008, 2102, 2108, 2112  | 4.35  | Initial solution version  |

### Storage Backplane Expander - Azure Stack Hub

| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2102, 2108, 2112  | 2.52  | - Addressed an issue with select 3rd party utilities where the LED Identify operation continues to blink after a planned drive replacement operation as completed.<br/>- Addressed a firmware update issue when performed when no hard drives are present.  |
...
| Release version | Driver version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206  | 1.2.0.1052  | Support for Windows Azure HCI Stack & Windows 2022 enabled  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2112  | 20.5.13  | Fixes:<br/>  - Resolved a critical error observed while restoring default settings for the Intel(R) Ethernet<br/>     Converged Network Adapter X710 adapter.  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2102, 2108, 2112  | 9.14.2.9  | - Updated to Dell recommended version<br/>- Sev 3 issue fix - avoid potential software exception at bootup<br/>- Sev 2 issue fix - PSU serial not showing in inventory.  |
...
| Release version | Firmware version | Changes                                |
|-----------------|------------------|----------------------------------------|
| 2206, 2112  | 10.5.2.7.374  | Initial solution version  |
