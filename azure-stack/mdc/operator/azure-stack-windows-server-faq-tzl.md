...
# Windows Server in Azure Stack marketplace FAQ - Modular Data Center (MDC)
...
**What if I downloaded the wrong version to offer users?**
...
**How can I activate Windows Server virtual machine?**
