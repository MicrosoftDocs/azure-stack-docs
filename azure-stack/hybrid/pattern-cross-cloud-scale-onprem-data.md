...
| | Azure Functions | [Azure Functions](/azure/azure-functions/) allow you to execute your code in a serverless environment without having to first create a VM or publish a web app. |
