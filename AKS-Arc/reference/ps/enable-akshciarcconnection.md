---
title: Enable-AksHciArcConnection for AKS hybrid
author: sethmanheim
description: The Enable-AksHciArcConnection PowerShell command enables the Arc connection on an AKS hybrid cluster.
ms.topic: reference
ms.date: 05/25/2021
ms.author: sethm 
...
## Synopsis
Enables Arc connection for an AKS hybrid cluster.
...
### Connect an AKS hybrid cluster to Azure Arc for Kubernetes using Azure user login 
...
### Connect an AKS hybrid cluster to Azure Arc for Kubernetes using a service principal
