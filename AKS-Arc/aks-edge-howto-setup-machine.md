...
1. On your machine, download the **AksEdge-k3s.msi** or **AksEdge-k8s.msi** file, depending on which Kubernetes distribution you want to use. Also, if you're creating a Windows worker node, you'll need the Windows node files.
   ...
   | File | Link |
   | ---- | ---- |
   | K8s installer (1.30.5) | [aka.ms/aks-edge/k8s-msi-1.27](https://aka.ms/aks-edge/k8s-msi)  |
   | K3s installer (1.30.5) | [aka.ms/aks-edge/k3s-msi-1.27](https://aka.ms/aks-edge/k3s-msi) |
   | K8s installer (1.29.4) | [aka.ms/aks-edge/k8s-msi](https://aka.ms/aks-edge/k8s-msi-1.29)  |
   | K3s installer (1.29.6) | [aka.ms/aks-edge/k3s-msi](https://aka.ms/aks-edge/k3s-msi-1.29) |
