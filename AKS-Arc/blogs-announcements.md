---
title: AKS Hybrid and Edge blogs and announcements
description: Learn about the latest blogs and announcements for Azure Kubernetes Service (AKS) Hybrid and Edge.
author: davidsmatlak
...
This article provides a list of blogs and announcements for Azure Kubernetes Service (AKS) Hybrid and Edge.
...
| Month | News |
|-|-|
| May | *Blog*: [AKS on Azure Local CloudCasa backup and restore integration](https://techcommunity.microsoft.com/blog/azurearcblog/aks-arc-on-azure-local-cloudcasa-backup-and-restore-integration/4410083) <br/>  *Blog*: [Unlocking AI Apps Across Boundaries with Azure](https://techcommunity.microsoft.com/blog/azurearcblog/unlocking-ai-apps-across-boundaries-with-azure/4410457) |
| Apr | *Blog*: [Comparing deployment options of AKS Hybrid and Edge](https://techcommunity.microsoft.com/blog/azurearcblog/comparing-deployment-options-of-aks-enabled-by-azure-arc-%F0%9F%93%83/4408896) |

## 2024

| Month | News |
|-|-|
| Nov | *Blog*: [Speed Innovation with Arc-enabled Kubernetes Applications](https://techcommunity.microsoft.com/blog/azurearcblog/speed-innovation-with-arc-enabled-kubernetes-applications/4298658) <br/> *Blog*: [AKS - Optimized for AI Workloads](https://techcommunity.microsoft.com/blog/azurearcblog/aks-arc---optimized-for-ai-workloads/4292435) <br/> *Blog*: [Introducing Azure Local, cloud infrastructure for distributed locations Hybrid and Edge](https://techcommunity.microsoft.com/blog/azurearcblog/introducing-azure-local-cloud-infrastructure-for-distributed-locations-enabled-b/4296017) <br/>*(Azure Local pricing includes AKS Hybrid and Edge)*<br/> *Video*: [Azure Local with lost cost hardware](https://youtu.be/yxlAfS9mh2E) <br/> *Video*: [Disconnected operations for Azure Local](https://www.youtube.com/watch?v=8VwhonI_Jq8)|
| July | *Blog*: [Compare feature sets for AKS Hybrid and Edge deployment options](https://techcommunity.microsoft.com/t5/azure-arc-blog/comparing-feature-sets-for-aks-enabled-by-azure-arc-deployment/ba-p/4188163)|
...
| Feb | **GA**: [AKS Hybrid and Edge is now available on Azure Stack HCI](https://techcommunity.microsoft.com/t5/azure-stack-blog/aks-enabled-by-azure-arc-is-now-available-on-azure-stack-hci/ba-p/4045648) |
...
[AKS Hybrid and Edge overview](overview.md)
