...
:::image type="content" source="./media/aks-bare-metal-create-cluster-portal/create-cluster.png" alt-text="Screenshot of Azure Arc Machine provisioning to deploy a cluster for AKS Arc for Azure Local on Linux." lightbox="./media/aks-bare-metal-create-cluster-portal/create-cluster 1.png":::
