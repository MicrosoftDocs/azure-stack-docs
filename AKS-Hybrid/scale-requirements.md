...
| Number of concurrent operations across all different AKS hybrid clusters such as upgrade/scaling, etc., excluding create for node pool or clusters per ARB.  | 32                                    |
