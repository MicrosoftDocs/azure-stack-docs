...
| Term                | Definition                                                                        |
|---------------------|-----------------------------------------------------------------------------------|
| Physical HCI Host   | A physical HCI cluster node, which typically sets a quorum for control plane VMs. |
