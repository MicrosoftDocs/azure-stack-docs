...
| --------------- | ------------------------------------------------------------ |
| [Kubernetes RBAC](kubernetes-rbac-23h2.md) | Designed to work on Kubernetes resources within your AKS Arc cluster. |
