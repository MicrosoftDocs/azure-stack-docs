...
| 2 | Did you install the ArcHCI PowerShell module? | `Install-Module -Name ArcHci -Force -Confirm:$false -SkipPublisherCheck -AcceptLicense` | Confirm that the ArcHci module version is atleast `0.2.20` by running the following command: `Get-Command -Module ArcHci` |
