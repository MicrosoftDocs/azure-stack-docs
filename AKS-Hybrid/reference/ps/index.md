...
| [Install-AksHci](./install-akshci.md) | Install the Azure Kubernetes Service on AKS hybrid agents/services and host. |
...
| [Restart-AksHci](./restart-akshci.md) | Restart Azure Kubernetes Service on AKS hybrid and remove all deployed Kubernetes clusters. |
