...
Copy the following PowerShell script into any 1 node in your Azure Stack HCI cluster.
```powershell
<#
.SYNOPSIS
...
Next, run the PowerShell script with the following input parameters from the same physical node:  
```
