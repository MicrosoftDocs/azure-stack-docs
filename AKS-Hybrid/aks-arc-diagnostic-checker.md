...
"@
$urlRecommendation = @"
Ensure that the logical network IP addresses have outbound internet access. If there is a firewall, ensure that AKS required URLs are accessible from Arc VM logical network.
"@
