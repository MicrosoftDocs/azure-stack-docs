...
If the problem persists, collect the following information before [creating a support request](aks-troubleshoot.md#open-a-support-request.md). Collect [AKS cluster logs](get-on-demand-logs.md) before creating the support request.
