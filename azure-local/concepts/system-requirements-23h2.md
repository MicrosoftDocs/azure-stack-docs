...
Azure Local supports the use of additional SAN storage through Fibre Channel. For certified solutions, consult your Original Equipment Manufacturer (OEM). For more information, see [External Storage Support for Azure Local](../concepts/external-storage-support.md).
