...
- **Improved Secure Boot Certificate readiness**: Starting with this release, Azure Local supports and gates the Secure Boot 2023 certificate update when applied through a platform update. This helps you prepare for upcoming Secure Boot changes while minimizing risk during updates. For more information, see [Manage Secure Boot updates](./manage/manage-secure-boot-updates.md).
