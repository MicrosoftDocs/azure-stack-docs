...
|Update| Build |Security update| What's new | Known issues |
|------|-------|---------------|------------|--------------|
| 2024.05 Baseline update | Version: 10.2405.0.24 <br><br> OS build: 25398.887 | [May OS security update](./security-update/security-update-may-2024.md) <br><br> Availability date: 2024-05-30 | [Features and improvements](./whats-new.md#features-and-improvements-in-2405) | [Known issues](./known-issues-2405.md) |
...
| 2024.02 Baseline update | Version: 10.2402.0.23 <br><br> OS build: 25398.709 | [Feb OS security update](./security-update/security-update-feb-2024.md) <br><br> Availability date: 2024-02-13 | [Features and improvements](./whats-new.md#features-and-improvements-in-2402) | [Known issues](./known-issues-2402.md) |
