...
>
> - If you're already on 11.2510.1002.87, you can upgrade the OS to 12.2510.1002.529.
> - If you aren't on 11.2510.1002.87, you can update to 11.2510.1002.93 first, and then upgrade to 12.2510.1002.529.
...
- End of support for 23H2 (OS version 25398.xxxx):
  ...
  - If you're running the 23H2 OS without the Azure Local solution, support is available until April 2026. After April 2026, you won't receive monthly security and quality updates for 23H2 (OS version 25398.xxxx). Support requests are only available for patching to a supported release.
...
| ------ | ------- | --------------- | ---------- | ------------ |
| 12.2602.1007.7 <br><br> Availability date: 2026-02-16 | 26100.32370 | [February OS security update](security-update/security-update.md?view=azloc-2602&preserve-view=true&tabs=new-deployments) | [Features and improvements](./whats-new.md?view=azloc-2602&preserve-view=true#features-and-improvements-in-2602) | [Known issues](./known-issues.md?view=azloc-2602&preserve-view=true) |
