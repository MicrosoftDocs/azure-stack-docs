...
|------|-------|---------------|------------|--------------|
| 2024.11 Feature update | Version: 10.2411.x.x <br><br> OS build: 25398.xxxx | [November OS security update](./security-update/security-update-nov-2024.md) <br><br> Availability date: 2024-11-xx | [Features and improvements](./whats-new.md#features-and-improvements-in-2411) | [Known issues](./known-issues-2411.md) |
