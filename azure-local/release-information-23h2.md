...
|------|-------|---------------|------------|--------------|------|
| 11.2507.xxxx.xx <br><br> 10.2507.x.xx <br></br> Availability date: 2505-07-16 | 25398.xxxx | [July OS security update](security-update/security-update.md?view=azloc-2507&preserve-view=true) | [Features and improvements](./whats-new.md?view=azloc-2507&preserve-view=true#features-and-improvements-in-2507) | [Known issues](./known-issues.md?view=azloc-2507&preserve-view=true) |
...
| Solution version | OS build | Security update | What's new | Known issues |
|------|-------|---------------|------------|--------------|
| 12.2507.xxxx.xx <br><br> Availability date: 2025-07-16 | 26100.xxxx | [July OS security update](security-update/security-update.md?view=azloc-2507&preserve-view=true&tabs=new-deployments) | [Features and improvements](./whats-new.md?view=azloc-2507&preserve-view=true#features-and-improvements-in-2507) | [Known issues](./known-issues.md?view=azloc-2507&preserve-view=true) |
