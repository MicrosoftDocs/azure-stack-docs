...
|------|-------|---------------|------------|--------------|
| 10.2411.1.XX <br><br> Availability date: 2024-12-12 | 25398.1308 | [December OS security update](./security-update/security-update-dec-2024.md) | [Features and improvements](./whats-new.md#features-and-improvements-in-24111) | [Known issues](./index.yml) |
