...
> [!IMPORTANT]
> The new deployments of this software use the **12.2508.1001.52** build. You can also update an existing deployment from 2507 using **11.2508.1001.51**.
...
| 10.2411.2.12 <br><br> Availability date: 2025-02-10 | 25398.1369 | [January OS security update](security-update/security-update.md?view=azloc-previous&preserve-view=true) | [Features and improvements](./whats-new.md?view=azloc-previous&preserve-view=true#features-and-improvements-in-24112) | [Known issues](./known-issues.md?view=azloc-previous&preserve-view=true) |
