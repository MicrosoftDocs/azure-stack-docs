...
- In Azure Local 2510 you must upgrade (23H2) 11.2510.x.x to (24H2) 12.2510.x.x before you can update to the subsequent 2511 release. This solution upgrade (11.2510.x.x to 12.2510.x.x) will be released as a separate step once available.
