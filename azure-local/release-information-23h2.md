...
> [!IMPORTANT]
> The new deployments of this software use the **12.2512.1002.16** build. You can also update an existing deployment from **12.2511.1002.5** to **12.2512.1002.16**.

#### [OS build 26100.xxxx](#tab/OS-build-26100-xxxx)

| Solution version | OS build | Security update | What's new | Known issues |
|------|-------|---------------|------------|--------------|
| 12.2512.1002.16 <br><br> Availability date: 2025-12-16 | 26100.xxx | [December OS security update](security-update/security-update.md?view=azloc-2512&preserve-view=true&tabs=new-deployments) | [Features and improvements](./whats-new.md?view=azloc-2512&preserve-view=true#features-and-improvements-in-2512) | [Known issues](./known-issues.md?view=azloc-2512&preserve-view=true) |
