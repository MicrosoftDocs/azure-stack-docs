...
When creating volumes on a single-node cluster, you must use PowerShell. See [Create volumes using PowerShell](/windows-server/storage/storage-spaces/create-volumes#create-volumes-using-windows-powershell).
