...
|------------------------------------------|----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Azure Machine Configuration | Azure Machine Configuration (formerly known as Azure Policy Guest Configuration) is provided by Azure Instance Metadata Service (IMDS). | IMDS requires that [Legacy OS support](#legacy-os-support) be enabled. |
