...
| Azure Machine Configuration | [Azure Machine configuration](/azure/governance/machine-configuration) (formerly Azure Policy Guest Configuration) is provided by Azure Instance Metadata Service (IMDS). It's available at no cost and enables auditing and configuring OS settings as code for machines and VMs. | Requires you to enable [Legacy OS support](#legacy-os-support). Needs Arc agent version 1.39 or later. See [Latest agent release](/azure/azure-arc/servers/agent-release-notes). |
