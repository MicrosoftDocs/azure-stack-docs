...
This article describes how to deploy a virtualized Azure Local instance on a host system running Windows Server 2022, Windows 11, or later operating system (OS). The host must have Hyper-V enabled for the deployment.
