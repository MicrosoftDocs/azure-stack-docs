...
| Step | Description |
|------------|------------------|
| Review [Known issues for disconnected operations](known-issues-disconnected-operations.md). | Check known issues with disconnected operations for Azure Local. |
