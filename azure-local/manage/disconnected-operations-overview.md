...
| Understand dedicated management cluster requirements and plan for hardware procurement. | [Dedicated management cluster for disconnected operations](disconnected-operations-control-plane-appliance.md) |
