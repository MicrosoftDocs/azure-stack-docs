...
description: Learn how to use disconnected operations to deploy and manage Azure Local. Build sovereign private clouds with compliance and security for remote deployments.
ms.topic: overview
author: ronmiab
ms.author: robess
ms.date: 02/13/2026
...
| Deploy the disconnected operations appliance on a dedicated management cluster. | [Prepare Azure Local for disconnected deployments](disconnected-operations-prepare-azure-local.md) |
