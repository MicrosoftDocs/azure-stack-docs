...
Make sure you register the required resource providers before deployment. For more information see [!INCLUDE [Registration](../includes/hci-regisration-azure-prerequisites.md)]. 
