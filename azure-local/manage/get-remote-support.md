...
![Screenshot of grant remote support access.](media/get-remote-support/grant-access-remote-support-overview.png)
...
![Screenshot of terms and conditions.](media/get-remote-support/terms-and-conditions.png)
...
![Screenshot of access granted.](media/get-remote-support/access-granted-view.png)

1.You can view the access level which also indicates the level of access granted

![Screenshot of access level granted.](media/get-remote-support/access-granted-level.png)
...
![Screenshot of machines enabled.](media/get-remote-support/remote-support-these-machines.png)
...
![Screenshot of extension overview.](media/get-remote-support/extensions-overview-page.png)
...
![Screnshot of updates overview.](media/get-remote-support/updates-overview.png)
