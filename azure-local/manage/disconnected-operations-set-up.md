...
1. Type `https://portal.autonomous.cloud.private`, sign in, and navigate to **Azure Local**. You should see the **Disconnected operations** tab if you're approved for disconnected operations.
