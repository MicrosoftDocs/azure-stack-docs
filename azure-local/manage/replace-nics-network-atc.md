...
For the related expansion workflow, see [Add NICs to an existing Network ATC intent](add-nics-network-atc.md).
...
:::image type="content" source="media/replace-nics-network-atc/nic-replace-before-failed-nic.png" alt-text="Diagram showing the cluster state before the replacement, with a failed NIC in the Management and Compute intent." lightbox="media/replace-nics-network-atc/nic-replace-before-failed-nic.png":::
...
:::image type="content" source="media/replace-nics-network-atc/nic-replace-phase-1-suspend-and-remove.png" alt-text="Diagram showing Phase 1 of the replacement: the target node is suspended and the failed NIC is removed from the intent." lightbox="media/replace-nics-network-atc/nic-replace-phase-1-suspend-and-remove.png":::
...
:::image type="content" source="media/replace-nics-network-atc/nic-replace-phase-2-physical-swap.png" alt-text="Diagram showing Phase 2 of the replacement: the physical NIC is replaced, renamed, and drivers are updated." lightbox="media/replace-nics-network-atc/nic-replace-phase-2-physical-swap.png":::
...
:::image type="content" source="media/replace-nics-network-atc/nic-replace-phase-3-add-replacement.png" alt-text="Diagram showing Phase 3 of the replacement: the replacement NIC is added back into the intent." lightbox="media/replace-nics-network-atc/nic-replace-phase-3-add-replacement.png":::
...
:::image type="content" source="media/replace-nics-network-atc/nic-replace-after-complete.png" alt-text="Diagram showing the cluster after the replacement is complete, with the node resumed and all NICs healthy in the intent." lightbox="media/replace-nics-network-atc/nic-replace-after-complete.png":::
...
:::image type="content" source="media/replace-nics-network-atc/nic-replace-storage-only-intent-reference.png" alt-text="Reference diagram showing a storage-only intent with dedicated RDMA NICs and no vSwitch." lightbox="media/replace-nics-network-atc/nic-replace-storage-only-intent-reference.png":::
...
- [Add NICs to an existing Network ATC intent](add-nics-network-atc.md)
