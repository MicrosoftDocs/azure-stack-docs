...
Here's a sample script to enable firewall auditing on host machines. Update the variables at the beginning and run this on an Azure Local instance with [Network Controller](../concepts/network-controller-overview.md) deployed:
...
- [SDN in Azure Local and Windows Server](../concepts/software-defined-networking.md).
