...
1. Select **+ Add VM Image**, then from the dropdown list, select **Add VM image from Azure Marketplace**.
...
1. In the **Create an image** page, on the **Basics** tab, enter the following information:
    ...
    1. **Image to download**: Select a VM image from the list of images in Azure Marketplace. The dropdown list shows all Azure Marketplace images that are compatible with your Azure Local.
...
1. Review image details and then select **Review and create**. By default, the new image uses the same resource group and instance details as the previous image.
...
1. To complete the operation, select **Create**.
