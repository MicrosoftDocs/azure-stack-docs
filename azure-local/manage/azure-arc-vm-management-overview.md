...
- **Infrastructure logical network**: A logical network associated with the Azure Local VM management and is created automatically when you deploy Azure Local. The Azure resource bridge uses this logical network for management purposes.
