...
Azure Local can host [various types of VMs](../concepts/compare-vm-management-capabilities#types-of-vms-on-azure-local), including Azure Local VMs enabled by Azure Arc, Azure Arc-enabled servers and Unmanaged VMs. Azure Local VMs provide the highest level of management capabilities in Azure portal, second only to [native Azure VMs](/azure/azure-local/concepts/compare-vm-management-capabilities).
