...
2. Download the [Point in Time Metrics dashboard (JSON)](https://raw.githubusercontent.com/Azure-Samples/AzureLocal/main/disconnected-operations/point-in-time-metrics.json), then upload it in the import dialog. For prerequisites and the full sample, see the [Azure-Samples/AzureLocal disconnected operations folder](https://github.com/Azure-Samples/AzureLocal/tree/main/disconnected-operations).
