...
:::image type="content" source="./media/disconnected-operations/network/aldo-dissaggregated-air-gapped.svg" alt-text="Screenshot of how the management cluster is deployed with disconnected operations in an airgapped mode." lightbox=" ./media/disconnected-operations/network/aldo-dissaggregated-air-gapped.svg":::
...
:::image type="content" source="./media/disconnected-operations/network/aldo-dissaggregated-limited-connectivity.svg" alt-text="Screenshot of how the management cluster is deployed with disconnected operations in a limited connected mode." lightbox=" ./media/disconnected-operations/network/aldo-dissaggregated-limited-connectivity.svg":::
::: moniker-end
