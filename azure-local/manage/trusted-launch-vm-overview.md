...
> [!NOTE]
> You can bring your own customized image and use it with Trusted launch VMs. However, since those images have not been validated, they are not guaranteed to work with Trusted launch VMs. Guest attestation will be disabled for custom images. For more information see, [Enable guest attestation](trusted-launch-guest-attestation.md).
