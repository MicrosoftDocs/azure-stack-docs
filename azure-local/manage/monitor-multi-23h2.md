---
title: Monitor multiple Azure Local systems with Insights
description: How to use Insights to monitor the health, performance, and usage of multiple Azure Local systems.
author: sethmanheim
ms.author: sethm
