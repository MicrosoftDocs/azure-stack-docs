...
| Does this option also allow me to use Windows Server: Azure edition? | Yes. | For more information, see [Windows Server versions](/windows-server/get-started/editions-comparison?pivots=windows-server-2025). |
