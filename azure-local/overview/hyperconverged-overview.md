...
| Storage | Storage Spaces Direct-based virtualized storage. External SAN storage with Fibre Channel and iSCSI is generally available for qualified vendors. |
