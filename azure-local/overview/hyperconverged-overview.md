...
| Storage | Storage Spaces Direct-based virtualized storage. External SAN storage with Fibre Channel is generally available and iSCSI is offered in preview for qualified vendors. |
