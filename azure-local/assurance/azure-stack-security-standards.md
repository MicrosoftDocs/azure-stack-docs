...
|Products |Evaluation status |Details |
|---------|---------|---------|
|Azure Local, versions 23H2 and 24H2 |**Completed** January 15, 2026 |Includes the Protection Profile for General Purpose Operating Systems (4.3), the PP-Module for VPN Client (2.4),  the PP-Module for Wireless Local Area Network Client (1.0), the PP-Module for Bluetooth (1.0), and the Functional Package for Transport Layer Security (2.0). Certification documents: [Security Target](https://download.microsoft.com/download/68f6bdfb-7a65-4f40-b40b-6f166ee35046/Security%20Target.pdf), [Administrative Guide](https://download.microsoft.com/download/56d34d76-4db1-48fd-b51e-1c8235736a4b/Administrative%20Guide.pdf), [Assurance Activity Report](https://download.microsoft.com/download/245eac29-1d93-4ac1-8a74-8540070d24c4/Windows%2011%20and%20Windows%20Server%202025%20GPOS%20Public%20Assurance%20Activity%20Report.pdf), and [Certification Report](https://download.microsoft.com/download/7cc6fd6c-30d5-49c4-aaa3-13240b827053/Windows%2011%20and%20Windows%20Server%202025%20GP%20OS%20Certification%20Report.pdf) |
