...
- You need to upgrade the security posture. For more information, see [Update security posture on Azure Local after upgrade](../manage-security-post-upgrade.md).
