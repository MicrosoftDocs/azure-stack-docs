...
This article describes how to create and manage access control lists (ACLs) on network-to-network interconnects (NNIs) for multi-rack Azure Local deployments.
...
|----|----|----|
| defaultAction | Default action to take. If you don't define it, traffic is permitted. | "defaultAction": "Permit" |
