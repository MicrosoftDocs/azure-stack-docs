...
- Read the blog post: [Azure Local blog](https://aka.ms/ignite25/blog/azurelocal).

- Learn more about [Deployment prerequisites for multi-rack deployments of Azure Local](./multi-rack-prerequisites.md) .
