---
title: Supported Operations for Azure Local Multi-rack Virtual Machines (VMs) Enabled by Azure Arc (Preview)
...
# Supported operations for Azure Local multi-rack VMs enabled by Azure Arc (preview)
