...
1. Use this command to get a list of all L3 isolation domains available in a resource group:
...
2. Create the internal network with BGP configuration and specified peering address:
