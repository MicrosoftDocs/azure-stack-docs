...
The following third-party migration options are offered by Microsoft partners. These options are available to you at an additional cost. The following third party migration options are available:
