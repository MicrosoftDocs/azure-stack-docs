...
- Ensure that adequate vCenter Server permissions are met. <!--For more information, see [VMware vSphere agentless requirements](/azure/azure-arc/vmware-vsphere/browse-and-enable-vcenter-resources-in-azure)-->.
