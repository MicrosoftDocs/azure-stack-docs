...
1. Select the update you wish to install and note it’s `ResourceId`. Review the details of the update to confirm you have selected the desired update to install.  
