...
- For 25398.x builds, use the **CombinedSolutionBundle** to update the Azure Local OS and solution components.
- For 26100.x builds, use the **CombinedSolutionBundle** to install a specific version of Azure Local.
