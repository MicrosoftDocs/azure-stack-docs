...
| 26100.6899 | [12.2510.1002.531](https://azurestackreleases.download.prss.microsoft.com/dbazure/AzureLocal/CombinedSolutionBundle/12.2510.1002.531/CombinedSolutionBundle.12.2510.1002.531.zip) <br><br> Availability date: 2026-02-17 | 116AEFD4E0513C6CB78A8A67C45FB0F4639067D20801F319F5C1920A981DA0A9 <br><br> **Note:** Update to this version if your cluster is running version 11.2510.x on 23H2. You must run the command `Enable-SolutionFeature -Name "24H2Ready"` before running the `Add-SolutionUpdate` command. |
