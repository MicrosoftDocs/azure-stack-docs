...
| Hewlett Packard Enterprise | Newer integrated systems:</br><br> DL380 Gen11 (only SKU P65984-B21)</br>DL145 Gen11 (only SKU P78955-B21)  | Solution Builder Extension and [Windows Admin Center Extension](https://dev.azure.com/WindowsAdminCenter/Windows%20Admin%20Center%20Feed/_artifacts/feed/WAC/NuGet/hpe.hci.snap-in/overview/1.3.0) | 1. Install [Standard Solution Builder Extension](https://myenterpriselicense.hpe.com/cwp-ui/product-details/SBE_UPDATES/-/sw_free) |
