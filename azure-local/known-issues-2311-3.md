---
title: Release notes with fixed and known issues in Azure Local 2311.3 release
description: Read about the known issues and fixed issues in Azure Local 2311.3 release.
author: ronmiab
ms.topic: conceptual
ms.date: 01/28/2025
ms.author: robess
...
# View known issues in Azure Local 2311.3 release


This article identifies the critical known issues and their workarounds in the Azure Local 2311.3 release.
...
> [!IMPORTANT]
> The production workloads are only supported on the Azure Local systems running the generally available 2311.3 release. To run the GA version, you need to start with a new 2311 deployment and then update to 2311.3.
