---
title: Release notes with fixed and known issues in Azure Stack HCI 2402.4 update release
description: Read about the known issues and fixed issues in Azure Stack HCI 2402.4 release.
author: ronmiab
ms.topic: conceptual
ms.date: 10/21/2024
ms.author: robess
...
# View known issues in Azure Stack HCI 2402.4 release

[!INCLUDE [applies-to](./includes/hci-applies-to-23h2.md)]

This article identifies the critical known issues and their workarounds in Azure Stack HCI 2402.4 release.

The release notes are continuously updated, and as critical issues requiring a workaround are discovered, they're added. Before you deploy your Azure Stack HCI, carefully review the information contained in the release notes.

> [!NOTE]
> To understand the supported update paths for this release, see [Azure Stack HCI, version 23H2 releases](./release-information-23h2.md#about-azure-local-releases).
