...
description: Discover how Azure Local offers scalable on-premises solutions for critical workloads, from single machines to hundreds of nodes, tailored to your needs.
...
| Hyperconverged deployments | Clusters of 1-16 machines using hyperconverged storage<br><br>You can also attach an external SAN for more storage capacity <sup>PREVIEW</sup> |
|---|---|
| Multi-rack deployments <sup>PREVIEW</sup> | Integrated racks of compute, storage, and networking that expand up to hundreds of nodes |
...
## Multi-rack deployments <sup>PREVIEW</sup>
...
Specific reference architectures exist for Azure Local deployments that run Microsoft 365 Local applications. For more information about Microsoft 365 Local, see \[link to Microsoft 365 Local docs\].
