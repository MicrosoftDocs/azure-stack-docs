...
|---------|---------|---------|
| Upgrade <!--35816797--> | Add node and repair node operations fail when running on 11.2510.2000.87 or 12.2510.2000.88, as these images were recalled and don't exist. | Upgrade your environment to 11.2510.2000.93 or 12.2510.2000.94. <br><br> If you need to run add node or repair node operations during the update from 1.2510.2000.87/12.2510.2000.88 to 11.2510.2000.93/12.2510.2000.94, [open a support case](/azure/azure-portal/supportability/how-to-create-azure-support-request) to overwrite the image validation.|
