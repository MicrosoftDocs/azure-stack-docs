...
| Deployment <!--31699269--> | During the Azure Local deployment and update, `ConfigureSecurityBaseline` fails at the **Apply security settings on servers** step. | This issue is now fixed. |
