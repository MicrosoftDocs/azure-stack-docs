...
| Azure Local VMs <!--34513309--> | VM Connect couldn't connect to Azure Local virtual machines if you deployed them in a different resource group than the Azure Local instance. | VM Connect now supports connectivity to Azure Local VMs across different resource groups from the Azure Local instance. |
