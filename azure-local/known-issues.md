...
|---------|---------|------------|
| Upgrade <!--36440701--> | When upgrading from 2510 to 2511, 2512, or 2601, AKS Arc cluster creation fails. | For detailed steps on how to resolve this issue, see [AKS Arc cluster creation fails on Azure Local 2511, 2512, or 2601 after upgrade from 2510](../AKS-Arc/cluster-create-fails-after-azure-local-upgrade.md). |
