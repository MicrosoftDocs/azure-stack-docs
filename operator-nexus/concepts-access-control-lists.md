...
• For new deployments, create the CP-TP ACL resource either during fabric creation or after the fabric is provisioned, followed by patching it to the Network Fabric resource. Because the CP-TP ACL resource isn't created by default, you must create it manually before you attach it to the Network Fabric resource.
