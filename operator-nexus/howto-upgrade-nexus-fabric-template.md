...
- Target Fabric must be healthy in a running state. Details on checking Fabric health can be found in [Fabric Runtime Upgrade](./howto-upgrade-nexus-fabric.md#required-preupgrade-validations).
