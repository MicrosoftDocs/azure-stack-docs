...
az networkcloud cluster baremetalmachinekeyset create \
  ...
  --user-list '[{"description":"Needs access for troubleshooting as a part of the support team","azureUserName":"userABC", "sshPublicKey":{"keyData":"from=\"192.0.2.1,192.0.2.5\" ssh-rsa   admin@vm"},"userPrincipalName":"example@contoso.com"},\
  {"description":"Needs access for troubleshooting as a part of the support team","azureUserName":"userXYZ","sshPublicKey":{"keyData":"from=\"192.0.2.1,192.0.2.5\" ssh-rsa   admin@vm"}, "userPrincipalName":"example@contoso.com"}]' \
...
az networkcloud cluster baremetalmachinekeyset update \
  ...
  "sshPublicKey":{"keyData":"from=\"192.0.2.1,192.0.2.5\" ssh-rsa   admin@vm"}, \
  "userPrincipalName":"example@contoso.com"},\
