...
For the full create command argument set, see [Create a Network Fabric](../../azure-stack-docs-pr/operator-nexus/howto-configure-network-fabric#create-a-network-fabric).
...
For more information, see [Bring Your Own Storage for Network Fabric](../../azure-stack-docs-pr/operator-nexus/howto-configure-bring-your-own-storage-network-fabric).
