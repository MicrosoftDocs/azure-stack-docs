...
The following *network rules* and *application rules* are used to put Network Fabric Controller traffic from version 6.5 and later on an allow list. These rules will also apply to cluster manager traffic in future releases.
